                            ...
                            <xsl:for-each select="//pr:Used/r:Description">
                                <xsl:choose>
                                    <xsl:when test="current()/r:Content[contains(text(),'Structural')]">
                                        <tr>
                                            <td class="xpath wrap">
                                                <xsl:value-of select="parent::node()/@xpath"/>
                                            </td>
                                            <td class="wrap">
                                                <xsl:value-of select="substring-after(current()/r:Content[starts-with(text(),'Required')],'Required: ')"/>
                                            </td>
                                            <td class="text-danger">
                                                <xsl:value-of select="substring-after(current()/r:Content[starts-with(text(),'CDC')],'CDC_UI_Label: ')"/>
                                                <xsl:value-of select="substring-after(current()/r:Content[starts-with(text(),'EQB_UI')],'EQB_UI_Label: ')"/>
                                            </td>
                                            <td>
                                                <xsl:value-of select="substring-after(current()/r:Content[starts-with(text(),'ElementType')],'ElementType: ')"/>
                                            </td>
                                            <td>
                                                <xsl:value-of select="substring-after(current()/r:Content[starts-with(text(),'ElementRepeatable')],'ElementRepeatable: ')"/>
                                            </td>
                                            <td class="usage wrap">
                                                <xsl:value-of select="substring-after(current()/r:Content[starts-with(text(),'Usage')],'Usage: ')"/>
                                            </td>
                                        </tr>
                                    </xsl:when>
                                    <xsl:otherwise>
